...
if (isset($_SESSION["user_info"]) && !empty($_SESSION["user_info"])) {
    ...
    if ($_SESSION["user_info"]['user_type'] == 'student') {
        /* Redirect browser */
        header("Location: http://localhost/bluestone/php/student.php");
        exit();
    }
}
?>
...
<body data-new-gr-c-s-check-loaded="14.1010.0" data-gr-ext-installed="">
    <div class="body-inner">
                ...
                <div class="row">
                    ...
                    <nav class="collapse navbar-collapse clearfix" role="navigation">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown">
                                <a href="https://bluestoneocs.com/gallery.html#" class="dropdown-toggle" data-toggle="dropdown">Company <i class="fa fa-angle-down"></i></a>
        ...
        <!--/ Header end -->
        <section class="register-page main">
            <div class="container">
                <div class="main-head text-center mt-5">
                    <h2>REGISTER WITH US</h2>
                    <span class="title-desc">Enter your details to create a portal with us.</span>
                </div>
                <div class="form">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row">
                                <div class="info">(* Required Field).</div>
                            </div>
                            <form id="contactform" class="row" action="" name="contactform" method="post">
                                <fieldset>
                                    <div class="row">
                                        <div class="col-12 col-md-4">
                                            <div class="form-group">
                                                <label>First Name <span class="info">*</span></label>
                                        ...
                                        <div class="col-12 col-md-4">
                                            <div class="form-group">
                                                <label>Last Name <span class="info">*</span></label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-6">
                                            <div class="form-group">
                                                <label>Email <span class="info">*</span></label>
                                                <input type="email" name="email" id="email" class="form-control" placeholder="Your Email" required />
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Phone Number <span class="info">*</span></label>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Create Password <span class="info">*</span></label>
                                                <input type="password" minlength="8" name="password" id="password" class="form-control" placeholder="Your Password" required />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                ...
                                <div class="text-center">
                                    <br />
                                    <button class="btn btn-primary solid blank" type="submit" value="SEND" id="submit">
                                        Create Account
                                    </button>
                                </div>
                            </form>
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="copyright-info">
                        © Copyright 2021.
                        <span>Designed by
                            <a href="http://www.feduni.com/" target="_blank">M1 Team:Feduni</a></span>
                    </div>
                </div>
            </div>
            <!--/ Row end -->
            <div id="back-to-top" data-spy="affix" data-offset-top="10" class="back-to-top affix-top" data-original-title="" title="">
            ...
            $("#contactform").validate({
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        ...
                        alert(data.message);
                        if (data.success) {
                            $('form#contactform').find("input[type=text],input[type=email],input[type=password],input[type=number], textarea").val("");
                        }
                    });
                }
            });

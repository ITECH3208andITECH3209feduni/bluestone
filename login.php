        ...
        <section class="main">
            <div class="container">
                <div class="main-head text-center">
                    ...
                    <span class="title-desc">Enter your email address and password to login to your portal.</span>
                </div>
                <div class="form">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                ...
                                <form id="loginForm" class="row" action="" name="loginForm" method="post">
                                    <fieldset>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>Username <span class="info">*</span></label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>Password <span class="info">*</span></label>
                                                    <input type="password" name="password" id="password" class="form-control" minlength="8" placeholder="Your Password" passwordCheck="passwordCheck" required />
                                                </div>
                                            </div>
                                        </div>
                                    </fieldset>
                        ...
                        <div class="col-12 text-center">
                            ...
                            <p>Forgot Password? <a href="reset.php">Reset Now</a></p>
                        </div>
                    </div>
                </section>
            </div>
                ...
                $("#loginForm").validate({
                    submitHandler: function(form) {
                        ...
                        $.ajax({
                            ...
                            alert(data.message);
                            if (data.success) {
                                $('form#loginForm').find("input[type=text],input[type=email],input[type=password],input[type=number], textarea").val("");

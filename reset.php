        ...
        <section class="main">
            <div class="container">
                <div class="main-head text-center">
                    ...
                    <span class="title-desc">Enter the details and new password for your Portal Login.</span>
                </div>
                <div class="form">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                ...
                                <form id="resetForm" class="row" action="https://bluestoneocs.com/contact.php" name="contactform" method="post">
                                    <fieldset>
                                        <div class="row">
                                            <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>Phone <span class="info">*</span></label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>New Password <span class="info">*</span></label>
            ...
            jQuery.validator.addMethod("passwordCheck", function(value, element) {
                ...
                $("#resetForm").validate({
                    ...
                    submitHandler: function(form) {
                        var formData = $('form#resetForm').serialize()
                        $.ajax({
                            type: "POST",
                            url: "php/reset.php",
                            data: formData,
                            ...
                            alert(data.message);
                            if (data.success) {
                                $('form#resetForm').find("input[type=text],input[type=email],input[type=password],input[type=number], textarea").val("");
                            }
                        });
                    }
                });
